...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🚀 Initializing BTC 6-Month Backtest...");
    ...
    println!("\n📋 Backtest Results (BTC 6-Month Horizon)");
    println!("==========================================");
    println!("Start Price:       ${:.2}", start_price);
    println!("End Price (Act):   ${:.2}", end_price_actual);
    println!("End Price (Pred):  ${:.2}", end_price_predicted);
    println!("------------------------------------------");
    println!("MAE:               ${:.2}", mae);
